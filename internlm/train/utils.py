...
def create_param_groups(model, weight_decay):
    parameters = {"params": [param for name, param in model.named_parameters() if "vit" not in name and "vision_proj" not in name and param.requires_grad == True], "name": "default", "weight_decay": weight_decay}
