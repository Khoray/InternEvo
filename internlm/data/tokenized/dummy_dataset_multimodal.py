...
class RandomDatasetMultimodal(Dataset):
    ...
    def __init__(self, num_samples=10000, max_len=2048, image_token_id=200000, image_size=336, image_patch_size=14, image_token_size=(336//14)**2) -> None:
        super().__init__()
        ...
        data = []
        lengths = []
        images = [[torch.randn((3, image_size, image_size))] for _ in range(num_samples)] # num_samples x img_num x tensor(C x H x W)
